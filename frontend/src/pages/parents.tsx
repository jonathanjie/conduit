...
export default function ParentsPage() {
  ...
  const columns: Column<TelegramUser>[] = [
    ...
    },
    {
      ...
      header: 'Deactivated',
      accessor: (u) =>
        u.deactivatedAt ? formatDate(u.deactivatedAt) : <span className="text-gray-400">—</span>,
    },
    {
      key: 'actions',
      header: '',
      ...
      accessor: (u) => (
        <button
          onClick={() =>
            setActionUser({ user: u, action: u.isActive ? 'deactivate' : 'activate' })
          }
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-900 font-heading">Parents</h2>
        <p className="text-sm text-gray-500">Telegram-registered parents</p>
      </div>
      ...
      <ConfirmDialog
        ...
        title={actionUser?.action === 'deactivate' ? 'Deactivate Parent' : 'Reactivate Parent'}
        description={
